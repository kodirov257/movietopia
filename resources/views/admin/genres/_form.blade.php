        ...
        <div class="card card-gray card-outline">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    {!! Html::text('name_uz', old('name_uz', $genre->name_uz ?? null))->class('form-control' . ($errors->has('name_uz') ? ' is-invalid' : ''))->required() !!}
                ...
                <div class="form-group">
                    ...
                    {!! Html::text('name_uz_cy', old('name_uz_cy', $genre->name_uz_cy ?? null))->class('form-control' . ($errors->has('name_uz_cy') ? ' is-invalid' : '')) !!}
                    @if($errors->has('name_ru'))
                ...
                <div class="form-group">
                    ...
                    {!! Html::text('name_ru', old('name_ru', $genre->name_ru ?? null))->class('form-control' . ($errors->has('name_ru') ? ' is-invalid' : ''))->required() !!}
                    @if($errors->has('name_ru'))
                ...
                <div class="form-group">
                    ...
                    {!! Html::text('name_en', old('name_en', $genre->name_en ?? null))->class('form-control' . ($errors->has('name_en') ? ' is-invalid' : ''))->required() !!}
                    @if($errors->has('name_ru'))
                ...
                <div class="form-group">
                    ...
                    {!! Html::text('slug', old('name_en', $genre->slug ?? null))->class('form-control' . ($errors->has('slug') ? ' is-invalid' : '')) !!}
                    @if ($errors->has('slug'))
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Html::text('meta_title', old('meta_title', $genre ? $genre->meta_json->title : null))
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Html::text('meta_keywords', old('meta_keywords', $genre ? $genre->meta_json->keywords : null))
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Html::textarea('meta_description', old('meta_description', $genre ? $genre->meta_json->description : null))
...
<div class="form-group">
    <button type="submit" class="btn btn-primary">{{ trans('adminlte.' . ($genre ? 'edit' : 'save')) }}</button>
</div>
