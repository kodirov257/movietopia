...
return [
    ...
    'film' => [
        'add' => 'Добавить фильм',
        'draft' => 'Черновик',
        'moderation' => 'Требуется модерация',
        'deleted' => 'Удалённый',
        'active' => 'Активный',
        'connected_film' => 'Связанный фильм',
        'location' => 'Локация',
        'company' => 'Компания',
        'edit_description' => 'Редактировать описание',
        'edit_storyline' => 'Редактировать сюжетную линию',
        'add_slogan' => 'Добавить слоган',
        'add_synopsis' => 'Добавить краткий обзор',
        'add_trivia' => 'Добавить слухи',
        'add_goof' => 'Добавить ошибку',
        'add_connection' => 'Добавить связанный фильм',
        'add_location' => 'Добавить локацию',
        'add_company' => 'Добавить компанию',
        'add_release_date' => 'Добавить дату релиза',
        'add_alternate_version' => 'Добавить альтернативную версию',
    ],
];
