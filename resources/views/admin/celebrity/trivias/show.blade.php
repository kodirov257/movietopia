<x-admin-page-layout>
    @section('content')
        <div class="d-flex flex-row mb-3">
            <a href="{{ route('dashboard.celebrities.trivias.edit', ['celebrity' => $celebrity, 'trivia' => $trivia]) }}" class="btn btn-primary mr-1">{{ trans('adminlte.edit') }}</a>
            <form method="POST" action="{{ route('dashboard.celebrities.trivias.destroy', ['celebrity' => $celebrity, 'trivia' => $trivia]) }}" class="mr-1">
                @csrf
                @method('DELETE')
